...
class Mapping
{
    ...
    /**
     * @param array  $sources File name without locale suffix
     * @param array  $locales Locale to append to source
     * @param string $output  E.g.: [dirname][filename][locale][extension][ext]
     * @param mixed  $postfix ??
     */
